...
class AdminNotifications extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Control Room Alerts'),
      ),
      body: SafeArea(
        child: notifs.isEmpty
            ? Center(child: Text('No system alerts.', style: AppTypography.bodyMedium))
            : ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    onTap: () => Navigator.pushNamed(context, AppRoutes.adminAllIncidents),
