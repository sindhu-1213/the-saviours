...
class PoliceNotifications extends StatelessWidget {
  const PoliceNotifications({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Traffic Radar Alerts'),
      ),
      body: SafeArea(
        child: notifs.isEmpty
            ? Center(child: Text('No traffic notifications.', style: AppTypography.bodyMedium))
            : ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return InkWell(
                    onTap: () => Navigator.pushNamed(context, AppRoutes.policeTrafficClearance),
